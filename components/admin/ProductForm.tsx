...
export default function ProductForm({
  ...
  const sh = "text-sm font-bold text-gray-800 mb-5 flex items-center gap-2";
  ...
  return (
    /*
      The component owns its own full-page shell.
      The parent page should render ONLY this component with no extra wrappers,
      padding, or layout divs that add spacing above it.
    */
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4 sticky top-0 z-20">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="px-5 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 font-medium transition"
            >
              Discard
            </button>
            <button
              ...
              disabled={busy}
              className="px-6 py-2 text-sm bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white rounded-xl font-semibold transition flex items-center gap-2 shadow-md shadow-indigo-200"
            >
              {busy ? (
              ...
              >
                {uploading ? (
                  ...
                  <>
                    ...
                    <p className="text-sm font-semibold text-gray-600 group-hover:text-indigo-600 transition">
              ...
              {form.variants.length === 0 ? (
                <div className="text-center py-10 border-2 border-dashed border-gray-100 rounded-xl">
                  ...
                  <p className="text-xs text-gray-300 mt-1">
                    Variants hold their own SKU, price, stock and images.
                  </p>
                </div>
              ) : (
                <>
                    ...
                    <div className="bg-slate-50 rounded-xl p-5 space-y-5 border border-gray-100">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-bold text-gray-700">
                          {form.variants[activeVariantIdx].sku ||
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              placeholder="0.00"
                              value={
                                form.variants[activeVariantIdx].originalPrice
                              }
                              onChange={(e) =>
                                updateVariant(
                                  activeVariantIdx,
                      ...
                      <div>
                        ...
                        <div
                          onClick={() =>
                            variantFileRefs.current[activeVariantIdx]?.click()
                          }
                        ...
                        >
                          {uploadingVariantIdx === activeVariantIdx ? (
                            ...
                            <>
                              ...
                              <p className="text-xs font-semibold text-gray-500 group-hover:text-indigo-600 transition">
                          ...
                          <input
                            ref={(el) => {
                              variantFileRefs.current[activeVariantIdx] = el;
                            }}
                            type="file"
                            multiple
                            accept="image/*"
                            className="hidden"
                            onChange={(e) =>
                              handleVariantImageUpload(e, activeVariantIdx)
                            }
                          />
                        </div>
                        {form.variants[activeVariantIdx].images.length > 0 && (
                          <div className="flex gap-3 mt-3 flex-wrap">
                            {form.variants[activeVariantIdx].images.map(
                              (img, ii) => (
                                <div key={ii} className="relative group">
                                  ...
                                  <button
                                    onClick={() =>
                                      removeVariantImage(activeVariantIdx, ii)
                                    }
            ...
            <div className={card}>
              ...
              <div className="space-y-3">
                {form.attributes.map((attr, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 bg-slate-50 p-3 rounded-xl border border-gray-100"
                  >
                    ...
                    <button
                      ...
                      className="text-gray-300 hover:text-red-500 transition mt-0.5"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                ...
                {Object.entries(form.specifications).map(([key, value]) => (
                  <div key={key} className="flex gap-2 items-center">
                    <input
                      value={key}
                      readOnly
                      className={`${inp} flex-1 bg-slate-50`}
                    />
                    <input
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                {(
                  [
                    {
                      key: "isActive",
                      label: "Active",
                      desc: "Product is live on store",
                      color: "bg-emerald-500",
                    },
                    {
                      key: "isFeatured",
                      label: "Featured",
                      desc: "Shown in featured section",
                      color: "bg-amber-500",
                    },
                    {
                      key: "isSuggestedForHome",
                      label: "Suggest for Home",
                      desc: "Displayed on homepage",
                      color: "bg-sky-500",
                    },
                    {
                      key: "isOffer",
                      label: "Is Offer",
                      desc: "Mark as promotional offer",
                      color: "bg-rose-500",
                    },
                  ] as {
                    key: keyof FormState;
                  ...
                  >
                    ...
                    >
                      <div
                        className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-transform ${(form[key] as boolean) ? "translate-x-6" : "translate-x-1"}`}
                      />
                    </button>
                  </div>
                ))}
                ...
                {form.isOffer && (
                  <div className="pt-2 border-t border-gray-100">
                    <label className={lbl}>Offer Description</label>
                    <input
                  ...
                  <div key={key}>
                    ...
                    <div className="relative h-1.5 bg-gray-100 rounded-full overflow-hidden mb-1.5">
                      <div
                        ...
                        style={{
                          width: `${(form.ratingBreakdown[key] / 5) * 100}%`,
                        }}
                      />
                    </div>
                    <input
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                onClick={handleSubmit}
                disabled={busy}
                className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white rounded-xl text-sm font-bold transition flex items-center justify-center gap-2 shadow-lg shadow-indigo-200"
              >
                {busy ? (
                  <span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                ) : (
